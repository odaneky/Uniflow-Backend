...
public interface AuditTrail {
    ...
    final class Action {
        ...
        /** G5: a reviewer scored an application — one of possibly several independent scores. */
        public static final String APPLICATION_SCORE_SUBMITTED = "APPLICATION_SCORE_SUBMITTED";
