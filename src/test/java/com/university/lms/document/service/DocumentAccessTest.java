...
/**
 * A5: {@code DocumentService.downloadForStaff}/{@code findMetadata} narrowed from a blind {@code
 * isStaff()} using a different resolution path than the course-scoped guards — a document has no
 * course or department of its own, so this resolves owner &rarr; student record &rarr; programme
 * &rarr; department instead. Same fail-open safety property throughout.
 */
